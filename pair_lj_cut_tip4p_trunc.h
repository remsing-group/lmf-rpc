...
PairStyle(lj/cut/tip4p/trunc,PairLJCutTIP4PTrunc)

#else

#ifndef LMP_PAIR_LJ_CUT_TIP4P_TRUNC_H
#define LMP_PAIR_LJ_CUT_TIP4P_TRUNC_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutTIP4PTrunc : public Pair {
 public:
  PairLJCutTIP4PTrunc(class LAMMPS *);
  virtual ~PairLJCutTIP4PTrunc();
